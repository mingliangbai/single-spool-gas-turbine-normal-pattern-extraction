...
load dataab1.mat
cd ..
cd ./'NARX network with other parameter combinations'/'narx_p_156'
...
fdelay=3;%3-order PACF is significant larger than zero
...
%%
save narx_p_156.mat acctrainnorbox accvalnorbox acctestnorbox  accab1box  acctrainnorsig accvalnorsig acctestnorsig  accab1sig  trainmae trainmape valrmse valmae valmape testmae testmape testrmse
cd ..
