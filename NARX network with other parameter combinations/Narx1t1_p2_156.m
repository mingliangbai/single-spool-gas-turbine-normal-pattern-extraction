...
load dataab1.mat
cd ..
cd ./'NARX network with other parameter combinations'/'Narx1t1_p2_156'
egtsmooth=p2;
%% 建立非线性自回归模型
close all
...
%%
save Narx1t1_p2_156.mat acctrainnorbox accvalnorbox acctestnorbox  accab1box acctrainnorsig accvalnorsig acctestnorsig  accab1sig trainmae trainmape valrmse valmae valmape testmae testmape testrmse
cd ..
