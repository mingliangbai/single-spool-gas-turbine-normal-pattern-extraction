...
load dataab1.mat
cd ..
cd ./'NARX network with other parameter combinations'/'Narx1fuel_p_156'
egtsmooth=p;
%% 建立非线性自回归模型
close all
inputSeries=num2cell(fuel');
...
%%
save Narx1fuel_p_156.mat acctrainnorsig accvalnorsig acctestnorsig  accab1sig trainrmse valrmse testrmse
cd ..
