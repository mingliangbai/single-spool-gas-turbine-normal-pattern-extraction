...
load dataab1.mat
cd ..
cd ./'NARX network with other parameter combinations'/'Narx4inputs_P_156'
egtsmooth=p;
%% 建立非线性自回归模型
close all
inputSeries=num2cell([fuel';t1';p2';t4']);%two external inputs, fuel and t1 are column vectors of the same length
...
for hiddenLayerSize = 1:20
    ...
    %% 异常检测1
    %         cd ..
    inputSeries3=num2cell([fuelab1';t1ab1';p2ab1';t4ab1']);%two external inputs, fuel and t1 are column vectors of the same length
